...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent { MaterialTheme(colorScheme = NortechScheme) { Surface(Modifier.fillMaxSize()) { NortechApp() } } }
    }
}
